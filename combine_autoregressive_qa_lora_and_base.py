...
combined_model_with_filtered_medical_autoregressive_lora_path = os.path.join(root_code_folder, "Medical autoregressive weights/combined_model_with_filtered_medical_autoregressive_lora.pt")

combined_medical_autoregressive_lora_param_difference_file_path = os.path.join(root_code_folder, "Medical autoregressive weights/combined_medical_autoregressive_lora_param_difference.txt")
...
# print("Keys in filtered_autoregressive_qa_lora_weights:")
# for key in filtered_autoregressive_qa_lora_weights.keys():
#     print(key)
...
base_model_weights_medical_autoregressive = torch.load(base_model_weights_path, map_location=device)

combine_lora_and_base(base_model_weights_medical_autoregressive, filtered_medical_autoregressive_lora_weights, combined_model_with_filtered_medical_autoregressive_lora_path, alpha=512, rank=256,save = True)
combined_model_with_filtered_medical_autoregressive_lora_weights = torch.load(combined_model_with_filtered_medical_autoregressive_lora_path, map_location=device)
...
compare_model_parameters_with_percentage_to_file(
    ...
    lora_model=combined_model_with_filtered_medical_autoregressive_lora_weights,
    output_file=combined_medical_autoregressive_lora_param_difference_file_path
)
