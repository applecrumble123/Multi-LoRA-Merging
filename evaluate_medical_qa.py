...
base_general_qa_generated_qns_text_path = os.path.join(root_code_folder, "Medical QA Weights/base_general_qa_model_generated_answers.txt")
base_general_qa_results_path = os.path.join(root_code_folder, "Medical QA Weights/base_general_qa_model_results.txt")

merged_peft_medical_qa_generated_qns_text_path = os.path.join(root_code_folder, "Medical QA Weights/merged_peft_medical_qa_generated_answers.txt")
merged_peft_medical_qa_results_path = os.path.join(root_code_folder, "Medical QA Weights/merged_peft_medical_qa_model_results.txt")

combined_medical_qa_generated_qns_text_path = os.path.join(root_code_folder, "Medical QA Weights/combined_medical_qa_generated_answers.txt")
combined_medical_qa_results_path = os.path.join(root_code_folder, "Medical QA Weights/combined_medical_qa_model_results.txt")
